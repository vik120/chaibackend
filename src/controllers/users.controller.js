...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(ApiResponse(200,  user, 'User channel fetched successfully'))
})
...
const getwatchHistory = asyncHandler(async (req, res) => {
   ...
   return res.status(200, user, user[0].watchHistory, "User watch history fetch successfully")
})
